        ...
        <div class="row mt-5">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="disprag.php" method="post" autocomplete="off">
                            <!-- Email input -->
...
if(isset($_POST['login']))
{
  ...
  $query = "SELECT * FROM registration   $row = mysqli_fetch_assoc($data); ";
 ...
 //echo $count;         WHERE email='$email' AND password = '$password' ";
